import { resolveStatusLabel } from "@/features/empreendimentos/status";
import { resolveSecaoStatusLabel } from "@/features/memorial/status";
import { resolveUnidadeStatusLabel } from "@/features/unidades/status";
...
const map: Record<string, string> = {
  ...
  "Dados extraídos":
    "bg-[var(--color-ceu)]/10 text-[var(--color-ceu)] border-[var(--color-ceu)]/30",
  "Em validação":
    "bg-[var(--color-atencao)]/15 text-[oklch(0.45_0.13_85)] border-[var(--color-atencao)]/40",
  "Pronto para gerar":
    "bg-[var(--color-verde-claro)]/15 text-[var(--color-verde)] border-[var(--color-verde-claro)]/40",
  "Memorial gerado":
    "bg-[var(--color-verde-claro)]/15 text-[var(--color-verde)] border-[var(--color-verde-claro)]/40",
  "Em revisão":
    "bg-[var(--color-atencao)]/15 text-[oklch(0.45_0.13_85)] border-[var(--color-atencao)]/40",
  Aprovado:
    "bg-[var(--color-verde)]/15 text-[var(--color-verde-escuro)] border-[var(--color-verde)]/40",
  Exportado:
    "bg-[var(--color-verde-escuro)]/10 text-[var(--color-verde-escuro)] border-[var(--color-verde-escuro)]/30",
  // Unidade
  Validado:
    "bg-[var(--color-verde)]/15 text-[var(--color-verde-escuro)] border-[var(--color-verde)]/40",
  Pendente:
    "bg-[var(--color-atencao)]/15 text-[oklch(0.45_0.13_85)] border-[var(--color-atencao)]/40",
  Inconsistência:
    "bg-[var(--color-alerta)]/12 text-[var(--color-alerta)] border-[var(--color-alerta)]/40",
